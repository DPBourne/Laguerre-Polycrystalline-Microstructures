...
The examples are in MATLAB (Examples 5.1, 5.4, 5.5) and Python (Examples 5.1, 5.4). The ipynb file runs in [Google Colab](https://colab.research.google.com/) or in Jupyter Notebook if you have [pysdot](https://github.com/sd-ot/pysdot) and [VTK](https://pypi.org/project/vtk/) installed. 
